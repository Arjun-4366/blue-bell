...
export default function BookNowHero() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from('.bk-hero > *', { opacity: 0, y: 60, duration: 1.1, stagger: 0.15, ease: 'power3.out', delay: 0.3 });

      // Parallax scroll on bg
      gsap.fromTo('.bk-hero-bg',
        { y: 0 },
        {
          y: '15%',
          ease: 'none',
    ...
    <div className="hero-fixed-container">
      <section ref={ref} style={{
        ...
        <img
          ...
          alt="Luxury outdoor resort lobby"
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, textAlign: 'center' }}>
          <div className="bk-hero">
            ...
            <p style={{
              ...
              Book direct to lock in the lowest rates, complimentary spa welcome treatments, and personalized jungle trails.
            </p>
          </div>
        </div>
      </section>
