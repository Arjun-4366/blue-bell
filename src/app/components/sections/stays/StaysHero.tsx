  ...
  return (
    <div className="hero-fixed-container">
      <section ref={ref} style={{
        ...
        <img
          src="https://images.unsplash.com/photo-1582719508461-905c673771fd?w=1920&q=85&fit=crop"
          alt="Luxury villa bedroom view"
          className="stays-hero-bg"
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, textAlign: 'center' }}>
          <div className="stays-hero-content">
            ...
            <p style={{
              ...
              From intimate forest suites to premium family bungalows — find your personal sanctuary in Vythiri's green peaks.
            </p>
          </div>
        </div>
      </section>
