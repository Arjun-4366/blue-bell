        ...
        <div style={{
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{
              ...
              <span style={{ display: 'block', fontFamily: 'var(--font-sans)', fontSize: '2.2rem', fontWeight: 700, color: '#fff', lineHeight: 1 }}>15+</span>
              <span style={{ display: 'block', fontFamily: 'var(--font-sans)', fontSize: '0.55rem', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.85)', marginTop: '5px', lineHeight: 1.3 }}>Years of<br />Excellence</span>
            </div>
          </div>
          ...
          <div className="about-text-group">
            ...
            <h2 className="section-title about-reveal-el" style={{ marginBottom: '1.2rem' }}>
              A Sanctuary Born from<br />Wayanad's Soul
            </h2>
            <div className="divider about-reveal-el" />
            <p className="about-reveal-el" style={{ marginBottom: '1.3rem', fontSize: '1rem', color: 'var(--color-text-mid)' }}>
            ...
            <p className="about-reveal-el" style={{ marginBottom: '2.2rem', fontSize: '0.95rem', color: 'var(--color-text-soft)' }}>
            ...
            {/* Stats */}
            <div className="about-reveal-el" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '2.5rem' }}>
              {[
                ...
                >
                  <span style={{ display: 'block', fontFamily: 'var(--font-sans)', fontSize: '1.7rem', fontWeight: 700, color: 'var(--brand-cyan-muted)', lineHeight: 1 }}>{stat.value}</span>
                  <span style={{ fontFamily: 'var(--font-sans)', fontSize: '0.68rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--color-text-soft)', marginTop: '6px', display: 'block' }}>{stat.label}</span>
                </div>
              ))}
            </div>
