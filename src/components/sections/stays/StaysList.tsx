          ...
          {stays.map((stay) => (
            ...
            >
              ...
              <div style={{ padding: 'clamp(1.2rem, 2vw, 1.8rem)' }}>
                ...
                <div className="stay-footer" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 'clamp(0.8rem, 1.2vw, 1.1rem)', borderTop: '1px solid rgba(13,30,53,0.07)' }}>
                  <div>
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: 'clamp(1.2rem, 1.8vw, 1.5rem)', fontWeight: 700, color: 'var(--brand-cyan-muted)' }}>{stay.price}</span>
                    <span style={{ fontSize: 'clamp(0.65rem, 0.85vw, 0.72rem)', color: 'var(--color-text-soft)', marginLeft: '3px', fontFamily: 'var(--font-sans)' }}>/night</span>
                  </div>
